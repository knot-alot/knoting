...
GameObject Untie::create_floor(const std::string& name, vec3 position, float width, float depth) {
    ...
    cubeObj.get_component<components::Transform>().set_scale(glm::vec3(width, 1.0f, depth));
...
GameObject Untie::create_grass(const std::string& name, vec3 position, float width, float depth) {
    auto cubeObj = m_scene->create_game_object(name);
    cubeObj.get_component<components::Transform>().set_position(position);
    cubeObj.get_component<components::Transform>().set_scale(glm::vec3(width, 1.0f, depth));
    cubeObj.get_component<components::Transform>().set_rotation_euler(glm::vec3(0, 0, 0));
...
void Untie::create_level() {
    ...
    create_level_bottom();
    create_floor("lower_floor_top", vec3(0.229999542,0,-31),30,18.78263);
    create_floor("lower_floor_bottom", vec3(0.229999542,0,34.5),30,16.14291);
    create_floor("lower_floor_left", vec3(25.25,0,3), 4.57549, 15.4369);
    create_floor("lower_floor_right", vec3(-25,0,3), 4.37946, 15.4369);
    create_grass("Lower_floor_grass", vec3(0.229999542,0,3.25), 20.5185394,15.5414333);
