$input v_texcoord0,v_fragPos,v_normal,v_view,v_tangent,v_bitangent,v_fragPosLightSpace
...
void main()
{
	...
	vec3 lightColor;
	lightColor =  calcLight(0, tbn, v_fragPos, normal, view);
	lightColor += calcLight(1, tbn, v_fragPos, normal, view);
	lightColor += calcLight(2, tbn, v_fragPos, normal, view);
	lightColor += calcLight(3, tbn, v_fragPos, normal, view);
